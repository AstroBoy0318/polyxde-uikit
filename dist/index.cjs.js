...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 40 40" }, props),
        React__default['default'].createElement("image", { width: "40", height: "40", href: "/images/egg/logo.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", style: isMobile ? { height: "40px" } : { height: "40px", display: "none" } }, isPushed ? (React__default['default'].createElement(Icon$K, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$J, { width: "24px", color: "textSubtle" }))),
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, isMobile = _a.isMobile, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang, priceLink = _a.priceLink;
...
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout, cakeContract = _a.cakeContract;
    ...
    return (React__default['default'].createElement("div", null,
        cakeContract != null &&
            React__default['default'].createElement(Button, { onClick: addToken, disabled: isPending, mr: "10px", size: "sm" },
                "Add to ",
                React__default['default'].createElement("img", { src: "/images/icons/metamask.png", alt: "metamask", style: { width: "20px", marginLeft: "10px" } })),
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, profile = _a.profile, children = _a.children, cakeContract = _a.cakeContract;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            !isMobile &&
                React__default['default'].createElement(PanelBody, { isPushed: isPushed, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, cakeContract: cakeContract }),
        ...
        !isMobile &&
            React__default['default'].createElement(PanelFooter, { isPushed: isPushed, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink })));
};
