...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 40 40" }, props),
        React.createElement("image", { width: "40", height: "40", href: "/images/egg/logo.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", style: isMobile ? { height: "40px" } : { height: "40px", display: "none" } }, isPushed ? (React.createElement(Icon$K, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$J, { width: "24px", color: "textSubtle" }))),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null,
        cakeContract != null &&
            React.createElement(Button, { onClick: addToken, disabled: isPending, mr: "10px", size: "sm" },
                "Add to ",
                React.createElement("img", { src: "/images/icons/metamask.png", alt: "metamask", style: { width: "20px", marginLeft: "10px" } })),
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            !isMobile &&
                React.createElement(PanelBody, { isPushed: isPushed, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
            React.createElement(Flex, null,
                React.createElement(UserBlock, { account: account, login: login, logout: logout, cakeContract: cakeContract }),
        ...
        !isMobile &&
            React.createElement(PanelFooter, { isPushed: isPushed, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink })));
};
